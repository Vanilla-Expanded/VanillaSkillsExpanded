...
public static class PassionPatches
{
    public static void Do(Harmony harm)
    {
        ...
        harm.Patch(AccessTools.Method(typeof(SkillUI), nameof(SkillUI.GetLabel)), new HarmonyMethod(me, nameof(GetLabel_Prefix)));
        harm.Patch(AccessTools.Method(typeof(SkillUI), nameof(SkillUI.GetLearningFactor)), new HarmonyMethod(me, nameof(GetLearningFactor_Prefix)));
    ...
    {
        __result = new List<DebugActionNode>();
        foreach (var skill in DefDatabase<SkillDef>.AllDefs)
        {
            ...
            foreach (var passion in DefDatabase<PassionDef>.AllDefs)
                debugActionNode.AddChild(new DebugActionNode(passion.defName, DebugActionType.ToolMapForPawns)
                {
